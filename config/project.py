...
config['apptools.project.output'] = {
    ...
    'assets': {  # Asset API
        ...
        'cdn_prefix': [
            ...
            '0.west-1.usa.static.cdn.accsv.org',
            '1.west-1.usa.static.cdn.accsv.org',
            '2.west-1.usa.static.cdn.accsv.org',
            '3.west-1.usa.static.cdn.accsv.org',
            '4.west-1.usa.static.cdn.accsv.org',
            '5.west-1.usa.static.cdn.accsv.org',

            'west-2.usa.static.cdn.accsv.org',
            '0.west-2.usa.static.cdn.accsv.org',
            '1.west-2.usa.static.cdn.accsv.org',
            '2.west-2.usa.static.cdn.accsv.org',
            '3.west-2.usa.static.cdn.accsv.org',
            '4.west-2.usa.static.cdn.accsv.org',
            '5.west-2.usa.static.cdn.accsv.org',

            'usa.static.cdn.accsv.org',
            '0.usa.static.cdn.accsv.org',
            '1.usa.static.cdn.accsv.org',
            '2.usa.static.cdn.accsv.org',
            '3.usa.static.cdn.accsv.org',
            '4.usa.static.cdn.accsv.org',
            '5.usa.static.cdn.accsv.org'
